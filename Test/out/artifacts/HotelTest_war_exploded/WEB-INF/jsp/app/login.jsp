...
<script type="text/javascript">
	...
	function submitTable(){
		...
		var loginname = document.getElementById("loginname").value;    //没有value就只是获取 标签 ，加了value就是获取用户输入的值
		...
		/* 思考一下： 如何让上面两个if不成立时，不让代码走到下面这个提交页面，因为测试时我没有输入用户名或者密码，页面也跳转了
		* 		return  false; 阻止默认
		*  */
		//提交表单
	...
	<div class="login-page about">
		<div class="container"> 
			...
			<div class="login-agileinfo">
				<%-- 这边就是放提示信息的  id = "message" --%>
				<center> <div style="color: red" id="message">${message}</div></center>

				<form action="${pageContext.request.contextPath}/app/login.do" method="post" id="loginform"  onsubmit=" return submitTable()"> 
					<input type="hidden"  name="method" value="submitTable">  <%-- name = "method" --%>
