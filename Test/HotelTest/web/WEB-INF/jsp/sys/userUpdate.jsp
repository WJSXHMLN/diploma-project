...
window.onload=function(){
	...
	var roleIdOradios = document.getElementsByName("roleId");
	
	
	//遍历菜系select标签中所有的option标签
	$.each( roleIdOradios, function(i, roleIdOradio){
	  $(roleIdOradio).attr("checked",roleIdOradio.value == roleId);
	});
}
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td>用户角色</td>
							<td>
								<input type="radio"  value="0"   name="roleId"  />管理员
								<input type="radio"  value="1"  name="roleId"  />普通用户  （普通用户只能登录前台）
							</td>
						</tr>
					</table>
				</div>
